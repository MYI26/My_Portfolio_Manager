...
"")
        ...
        self.frameLogo.setMaximumSize(QSize(16777215, 82))
        ...
        self.frameName.setMaximumSize(QSize(16777215, 16777215))
        font = QFont()
        font.setPointSize(1)
        ...
        self.verticalLayout_2.setContentsMargins(0, 0, 70, 0)
        ...
        self.frameData.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.openPriceValue.setFont(font5)
        ...
        self.ClosePriceValue.setFont(font2)
        ...
        self.actionsLayout.setContentsMargins(260, 0, 0, 0)
